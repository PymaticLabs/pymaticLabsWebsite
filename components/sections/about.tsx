          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-16 h-16 rounded-full overflow-hidden">
                <Image src="/sergio.jpg" alt="Sergio" width={64} height={64} className="object-cover w-full h-full" />
              </div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-16 h-16 rounded-full overflow-hidden">
                <Image src="/eric.jpg" alt="Eric" width={64} height={64} className="object-cover w-full h-full" />
              </div>
              <div>
